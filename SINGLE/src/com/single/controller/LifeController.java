...
private void editPageClean(HttpServletRequest request, HttpServletResponse response)
	...
	// 예약 수정하기 실제 DB작업
		private void updateClean(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	 ...
	 /* 예약 취소(예약하자마자 취소와 예약 및 취소 변경 페이지에서의 취소 한번에 처리
	  * 바로 예약취소는 해당 회원의 가장 최근에 예약한 WASH_CODE를 받아서 처리
	  * 예약 및 취소 변경 페이지에서의 취소는 WASH_CODE와 status를 넘겨받아서 처리
	 */
