				...
				if (list != undefined) {
					$.each(list, function (i, item) {
						var InfoElements =
							...
							+ "<a href='./detailapi.jsp?id=" + item.contentid + "&item=" + item.contenttypeid + "'" + "target='_blank'>"
							+ "<div class='thumbnail'>"
							+ "<img class=" + "'img-responsive'" + "src=" + "'" + item.firstimage + "'" + "onError=" + "this.onerror=null;this.src='../../reseources/css/images/default.png';" + ">"
