...
<body>
	...
	<div class="container">
		...
		<div class="address">
			...
			<form id="reserv_form" method="post" action="/SINGLE/life/wash/update.do">
				...
				<input class="form-control" type="text" id="WASH_POSTCODE" name="WASH_POSTCODE" placeholder="우편번호" value="${wash_info.WASH_POSTCODE }" onclick="execDaumPostcode()">
				...
				<input class="form-control" type="text" id="WASH_DETAIL_ADDRESS" name="WASH_DETAIL_ADDRESS" placeholder="상세주소" style="width:400px;" value="${wash_info.WASH_DETAIL_ADDRESS }">
			</form>
		</div>
