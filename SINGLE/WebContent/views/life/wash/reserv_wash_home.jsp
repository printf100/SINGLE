	...
	<div class="container">
		...
		<div class="left">
				...
				<div class="left-button">
					...
					<button class="btn btn-outline-info" id="reserv-list">예약목록</button>
				</div>
	
		</div>
		<BR>
		<div class="right">
			<img id="img" class="rounded" alt="세탁 이미지" src="${pageContext.request.contextPath}/resources/images/wash/wash.jpg" >
		</div>
