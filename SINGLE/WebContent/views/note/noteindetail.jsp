...
<body>
		...
		<div class="row">
			...
			<div class="col-sm-8">
				<div class="contents-btn">
					...
					<button type="button" id="one-note" class="btn btn-info btn-sm">답장하기</button>
				</div>
				
				<div class="contents">
					<div class="form-group">
						<span style="font-size: 15pt;"><strong>${in.NOTE_TITLE }</strong></span><span style="color: #666666; font-size: 10pt; float: right;">${in.NOTE_SENDDATE }</span>
					</div>
					
					<div class="form-group">
						<label for="NOTE_FROM_NICKNAME"><strong>보낸 사람</strong></label><span class="info" style="color: #666666;">${in.NOTE_FROM_NICKNAME }</span>
					</div>
	...
	<input type="hidden" id="TO_MEMBER_NICKNAME" value="${in.NOTE_FROM_NICKNAME }">
	<input type="hidden" id="TO_MEMBER_CODE" value="${in.NOTE_FROM_CODE }">

	<input type="hidden" id="NOTE_CODE" value="${in.NOTE_CODE }">
