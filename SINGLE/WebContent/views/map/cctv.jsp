...
<body>
   ...
   <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=a358c4a162c62bd5de53bab3619c7a06&libraries=services"></script>
   <script>
      var c1 = null;
      ...
      var geocoder = new kakao.maps.services.Geocoder();
        ...
        var imageSrc = '/SINGLE/resources/images/img/cctv.png', // 마커이미지의 주소입니다    
   ...
   geocoder.addressSearch('<%=list.get(i).getAddress()%>', function(result, status) {
      ...
      iwContent = '<div style="padding:5px; width:150%;" >관리기관명 : <%=list.get(i).getManagement()%><br>주소 : <%=list.get(i).getAddress()%><br>사용 목적 : <%=list.get(i).getPurpose()%><br>관리기관 번호 : <%=list.get(i).getTel()%></div>';
                     if (status === kakao.maps.services.Status.OK) {
