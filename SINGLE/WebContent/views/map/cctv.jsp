...
<body>
	...
	<div class="map_wrap">
		...
		<ul id="category">
			...
			<li id="AT4" data-order="5"><span class="category_bg store"></span>
				관광지</li>
			<li id="cctv"><span class="category_han store"></span>CCTV</li>
			<li id="sc"><span class="category_han store"></span>안심택배</li>
			<li id="food"><span class="category_han store"></span>식재료</li>
	...
	<script>
        ...
        var imageSrc = '/SINGLE/resources/img/cctv.png', // 마커이미지의 주소입니다    
        ...
        var callback = function(result, status) {
            ...
            var cold = new kakao.maps.LatLng(result[0].y , result[0].x);
            
       		map.setCenter(cold);
       		
       		var circle = new kakao.maps.Circle({
       		    center : cold,  // 원의 중심좌표 입니다 
        ...
        geocoder.addressSearch('<%=my_address%>', callback);
	...
	geocoder.addressSearch('<%=list.get(i).getAddress()%>', function(result, status) {
		...
		iwContent = '<div style="padding:5px; width:100%;" >관리기관명 : <%=list.get(i).getManagement()%><br>주소 : <%=list.get(i).getAddress()%><br>사용 목적 : <%=list.get(i).getPurpose()%><br>관리기관 번호 : <%=list.get(i).getTel()%></div>';
							if (status === kakao.maps.services.Status.OK) {
