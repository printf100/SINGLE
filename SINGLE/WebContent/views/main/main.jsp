				...
				<div id="myCarousel" class="carousel slide" data-ride="carousel" style="padding-top: 80px; padding-bottom: 10px;">
				  ...
				  <div class="carousel-inner">
				    ...
				    <div class="carousel-item active">
				      <img src="../resources/images/main/main1.jpg" width="100%">
				    ...
				    <div class="carousel-item">
				      <img src="../resources/images/main/main2.jpg" width="100%;">
				      <div class="carousel-caption" style="text-align: right; margin-bottom: 450px;">
				      	<p class="slide_title_1"><b>혼자</b> 사는 사람을 위한<p>
				      	<p class="slide_title_2">맞춤형 지도</p>
				      	<p class="slide_subtitle" style="margin: 0;">집 주변 CCTV, 남는 식재료 공유, 동네 친구찾기, 안심택배 무인함 정보, 식당 위치 등</p>
				    ...
				    <div class="carousel-item">
				      <img src="../resources/images/main/main3.jpg" width="100%">
				      <div class="carousel-caption" style="text-align: left; margin-bottom: 450px;">
				      	<p class="slide_title_1"><b>혼자</b> 사는 사람을 위한<p>
				    ...
				    <div class="carousel-item">
				      <img src="../resources/images/main/main4.jpg" width="100%">
				      <div class="carousel-caption" style="text-align: left; margin-bottom: 450px;">
				    ...
				    <div class="carousel-item">
				      <img src="../resources/images/main/main5.jpg" width="100%">
				      <div class="carousel-caption" style="text-align: right; margin-bottom: 450px;">
				      	<p class="slide_title_1"><b>혼자</b> 사는 사람을 위한<p>
